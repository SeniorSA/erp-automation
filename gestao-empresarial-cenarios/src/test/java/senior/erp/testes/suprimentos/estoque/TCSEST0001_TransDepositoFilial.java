...
public class TCSEST0001_TransDepositoFilial {
	...
	/**
	 * Cenario01 para testar transferencia entre filais
	 */
	...
	public void testScenario01() {
		...
		SistemaSenior.preencherLinhaCorrenteGrade("GridOri", "Produto", "35046.0005", "Derivação", "001", "Dep.Origem",
				"D001-01", "Dep.Destino", "D001-02", "Documento", "0", "Lote Fab.", "", "Qtdade", "2", "Qtdade",
				"2,00000");
		...
		SistemaSenior.posicionarLinhaGradePorValor("GridCsl", "Origem", "35", "Família", "35046", "Lote Fab.", "008/17",
				"Produto", "35046.0005", "Descrição Produto", "ANTIBACTERIANO BORGAL 50ML - PADRAO", "Derivação", "001",
				"UM", "FR", "Depósito", "D001-01", "Saldo Lote", "193,00000", "Data Validade", "30/04/2019",
		...
		SistemaSenior.preencherCampo("ETnsSai", "90279");
		SistemaSenior.teclar(Tecla.TAB);
		SistemaSenior.preencherLinhaCorrenteGrade("GridOri", "Sel.", CaixaAtribuicao.DESMARCADO, "Produto",
				"35046.0005", "Derivação", "001", "Dep.Origem", "D001-01", "Dep.Destino", "D001-02", "Documento", "0");
		SistemaSenior.clicar("button1");// Este e um campo de mensagem que foi clicado em 'Sim' ou 'Nao'.
